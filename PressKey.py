...
class Keys(object):
  ...
  def move(self, x=0, y=0, **kwargs):
    if x == 0 or y == 0:
      return

    extra = ctypes.c_ulong(0)
    ii_ = _INPUTunion()
    ii_.mi = MOUSEINPUT(x, y, 0, 0x0001, 0,
...
if __name__ == '__main__':
  # ctypes.windll.user32.mouse_event(0x1, 0, 0, 10, 0)
  sleep(1)
  import win32gui
  import numpy as np
  import random
  ...
  #   # yx, yy = win32gui.GetCursorPos()
  #   keys.directMouse(-1920, -1080)
  #   keys.directMouse(x, y)
  #   xx, xy = win32gui.GetCursorPos()
  #   print(x, y, mp[x][y], xx, xy)
  mp = {}
  for lp in range(10):
    print(lp)
  ...
  with open("mp.txt", "w") as f:
    ...
    #     f.write("{} {} {} {}\n".format(
    #         i, j, int(mp[i][j][0] / 10 ), int(mp[i][j][1] / 10)))
  ...
  keys.parseKeyString("a_down,-4,a_up,0x01")
